...
type Listener struct {
	...
	// Listeners can listen for HTTP, TCP, and UDP (unsupported) connections
	//ListenerType {
	// The HTTP Listener contains configuration options for Gloo's HTTP-level features including request-based routing
	HttpListener *HttpListener `protobuf:"bytes,4,opt,name=http_listener,json=httpListener,proto3" json:"http_listener,omitempty"`
	// The TCP Listener contains configuration options for Gloo's TCP-level features including SNI-based routing
	TcpListener *TcpListener `protobuf:"bytes,5,opt,name=tcp_listener,json=tcpListener,proto3" json:"tcp_listener,omitempty"`
...
var fileDescriptor_c6a47f72e9923590 = []byte{
	...
	,
}
