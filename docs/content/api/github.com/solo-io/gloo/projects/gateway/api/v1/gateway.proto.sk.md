...
| `httpGateway` | [.gateway.solo.io.HttpGateway](../gateway.proto.sk/#httpgateway) | The type of gateway being created HttpGateway creates a listener with an http_connection_manager TcpGateway creates a listener with a tcp proxy filter GatewayType {. |  |
